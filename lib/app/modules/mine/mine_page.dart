...
class MinePage extends GetView<MineController> {
  ...
  Widget build(BuildContext context) {
    lLog('MTMTMT MinePage.build ${systemSetting.model.value?.auditSwitch} ');
    return Scaffold(
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: buildItem(
                                      "待付款", Assets.iconsMineDaifukuan,
                                          () {
                                        Get.toNamed(
                                            RoutesID.ORDER_PAGE, arguments: {
                                          "index": 1,
                                        });
                                      }),
                                ),
                                    ...
                                    children: [
                                      Expanded(
                                        child: buildItem("我的仓库",
                                            Assets
                                                .iconsMineMaiMaiWodecangku, () {
                                              Get.toNamed(
                                                  RoutesID.SELLER_ORDER_PAGE,
                                                  arguments: {"index": 0});
                                            }),
                                      ),
                                      Expanded(
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: buildItem(
                                                "我的钱包",
                                                Assets.iconsMineWodeqianbao,
                                                    () {
                                                  Get.toNamed(
                                                      RoutesID.WALLET_PAGE);
                                                }),
                                          ),
                                          Expanded(
                                            child: buildItem("邀请好友",
                                                Assets
                                                    .iconsMineYaoqinghaoyou, () {
                                                  Get.toNamed(
                                                      RoutesID.INVITE_PAGE);
                                                }),
                                          ),
                                          Expanded(
                                            child: buildItem("收货地址",
                                                Assets
                                                    .iconsMineShouhuodizhi, () {
                                                  // 跳转地址管理页
                                                  Get.toNamed(
                                                      RoutesID
                                                          .ADDRESS_MANAGE_PAGE);
                                          ...
                                          Obx(() {
                                            return Visibility(
                                              visible: (systemSetting.model
                                                  ...
                                                  ?.auditSwitch ?? 1) == 0,
                                              child: Expanded(
                                                child: buildItem("团队中心",
                                                    Assets
                                                        .iconsMineFenxiaozhongxin,
                                                        () {
                                                      Get.toNamed(
                                                          RoutesID
                                                              .DISTRIBUTION_PAGE);
...
/*
                                      Visibility(
                                        visible: (systemSetting.model.value?.auditSwitch ?? 0) == 0,
                                        child: Expanded(
                                          child: SizedBox(),
                                        ),
                                      )
