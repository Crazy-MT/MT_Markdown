                                    ...
                                    Expanded(
                                      child: buildItem(
                                        ...
                                        Get.toNamed(RoutesID.BUYER_ORDER_PAGE,
                                          ...
                                          showBadge: true,
                                          count:
                                              controller.daifukuanCount.value),
                                    ),
                                    Expanded(
                                      child: buildItem(
                                        ...
                                        Get.toNamed(
                                          ...
                                          showBadge: true,
                                          count:
                                              controller.yifukuanCount.value),
                                    ),
                                    Expanded(
                                      child: buildItem(
                                    ...
                                    Expanded(
                                      child: buildItem("待确认",
                                        ...
                                        Get.toNamed(RoutesID.SELLER_ORDER_PAGE,
                                          ...
                                          showBadge: true,
                                          count:
                                              controller.daiquerenCount.value),
                                    ),
                                    Expanded(
                                      child: buildItem("已完成",
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Obx(() {
                                        return Visibility(
                                          visible: (systemSetting.model.value
                                                      ?.auditSwitch ??
                                                  1) ==
                                              0,
                                          child: Expanded(
                                                            ...
                                                            SizedBox(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed: () {
                                                                  launchUrl(
                                                                      Uri.parse(
                                                                          'tel://${systemSetting.model.value?.hotline ?? ""}'));
                                                                },
                                                                // style: ButtonStyle(
