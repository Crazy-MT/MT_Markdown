...
class BankCardAddWidget extends StatelessWidget {
  ...
  Widget _contentWidget(BuildContext context) {
    ...
    return Container(
      ...
      child: Obx(
        (() => controller.bankcardInfo.value == null ? Center(child: Text("对方未设置该收款方式")) : Column(
              children: [
                _buildInputItem('姓名', controller.bankNameController, controller.bankcardInfo.value),
                ...
                _buildInputItem('银行卡号', controller.bankCardNumController, controller.bankcardInfo.value),
                _buildInputItem('所属银行', controller.bankBelongController, controller.bankcardInfo.value),
  ...
  Widget _buildInputItem(String title, TextEditingController editingController, UserBankCardModel? bankCardModel) {
