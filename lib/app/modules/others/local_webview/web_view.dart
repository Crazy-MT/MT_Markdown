...
class WebViewExample extends StatefulWidget {
  const WebViewExample({Key? key, this.cookieManager, this.str}) : super(key: key);
...
class SampleMenu extends StatelessWidget {
  ...
  SampleMenu(this.str, this.controller, CookieManager? cookieManager, {Key? key})
  ...
  Future<void> _onLoadHtmlStringExample(
      WebViewController controller, BuildContext context) async {
    await controller.loadHtmlString(str);
  }
