...
class GoodsDetailPage extends GetView<GoodsDetailController> {
                ...
                RichText(
                  text: TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: controller.goods.value?.currentPrice ?? "",
                          style: TextStyle(
                            fontSize: 26.sp,
                            fontWeight: FontWeight.w700,
                          ),
                            ...
                            text: TextSpan(
                                ...
                                children: [
                                  ...
                                  TextSpan(
                                    // todo
                                    text:
                                        "藏品归属人：${controller.goods.value?.ownerNickname}",
                                    style: TextStyle(
                                      fontSize: 14.sp,
                                      fontWeight: FontWeight.w500,
                                      color: Color(0xFF007B47),
          ...
          return RichText(
            text: TextSpan(
              children: [
                WidgetSpan(
                  child: Visibility(
                    visible: controller.goods.value?.commodityType == 1,
                    child: Container(
                      padding: EdgeInsets.symmetric(
                        horizontal: 6.w,
                        vertical: 1.w,
                ...
                TextSpan(
                  text: controller.goods.value?.name ?? "",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 18.sp,
                    fontWeight: FontWeight.w500,
          ...
          child: Obx(() {
            return Row(
              children: [
                ...
                Text(
                  (controller.goods.value?.inventory ?? "").toString(),
                  style: TextStyle(
                    fontSize: 14.sp,
                    fontWeight: FontWeight.w500,
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              SafeTapWidget(
                onTap: () {
                  if ((controller.goods.value?.inventory ?? 0) == 0) {
                ...
                : Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        SafeTapWidget(
                          onTap: () {
                            controller.goToSubmitOrderPage();
                          },
                          child: Container(
                            width: 335.w,
                            height: 44.w,
  ...
  _buildIntroParamsList() {
    var param = [];
    param.addAll(controller.goods.value?.showParams ?? []);
  ...
  _buildDesc() {
    return SliverPadding(
      padding: EdgeInsets.all(
          (controller.goods.value?.desc ?? "").isNotEmpty ? 25.w : 0.w),
      sliver: SliverToBoxAdapter(
        child: Container(
          // color: Color(0xff9dc2c4),
          child: Column(children: [
            Text(
              controller.goods.value?.desc ?? "",
              style: TextStyle(
                fontSize: 16.sp,
                fontWeight: FontWeight.w500,
              ),
